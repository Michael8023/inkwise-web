...
import { Check, ChevronLeft, ChevronRight, Coins, FileText, KeyRound, LogOut, MessageSquare, Search, ShieldCheck, Sparkles, Trash2, Users, X } from "lucide-react";
import { functionRequest, supabase, supabaseConfigured } from "./api";
import { RedemptionCodeManager } from "./redemption-admin";
import "./style.css";
...
function AdminApp() {
  ...
  const [adminPage, setAdminPage] = useState<"users" | "models" | "codes" | "balance" | "feedback">("users");
